...
\title{Development Plan for \progname{}}
\author{\authname}
\date{22.09.2025}
...
Nov 24 & Ruida Chen	& Updated poc section, make it consistent with our plan\\
Nov 26 & Ammar Sharbat & Updated Team Meeting Plan, Team Communication Plan, Team Member Roles, Appendix - Team Charter\\
\bottomrule
\end{tabularx}
\end{table}
...
This Development Plan defines how the Crazy Tens project will be organized and executed. It establishes scope, objectives, team structure, communication methods, workflow conventions, schedule, risk mitigation focus, technology stack, and coding standards.
...
The project is released under the \href{https://github.com/The-Crazy-Four-Games/Crazy-Eights-Game/blob/main/LICENSE}{MIT} License. All source code and documents may be used, modified, and redistributed in accordance with that license.

\section{Team Meeting Plan}

\subsection*{Meeting Frequency}
\begin{itemize}
  \item Meet as required/appropriate
  \begin{itemize}
    \item Once or twice before major deliverables (e.g., SRS, V\&V Plan, Design Document)
    \item Most work will be done and delegated through GitHub project management and via Discord server.\\
    On days prior to oncoming deadlines, teammates will express availability to make time to perform document and/or code review on Discord.
  \end{itemize}
  \item Additional ad hoc meetings scheduled as needed for deadlines or unblocking issues.
  \item After Spectember, monthly supervisor meetings with Dr. Paul Rapoport (virtual or in-person).
  Individual team members can meet with supervisor when needed for consultation.
\end{itemize}

\subsection*{Meeting Format}
\begin{itemize}
  \item Primary format: Online virtual meetings via MS Teams.
  \item Secondary format: In-person meetings in campus group study rooms when all members are available.
  \item Tertiary format: Voice channels on Discord for informal discussions / clarifications.
  \item Meeting roles (rotating):
  \begin{itemize}
    \item \textbf{Chair - Ammar}: Responsible for
    \begin{itemize}
      \item Preparing and sharing agenda (12+ hours in advance)
      \item Managing time allocation
      \item Facilitating inclusive discussion
    \end{itemize}
  \item \textbf{Note-taker - Ammar}: Records
    \begin{itemize}
      \item Key decisions
...
\begin{itemize}
  ...
  \item \textbf{Discord}: Primary platform for quick text communication. Daily informal updates, coordination of short-term tasks, and quick problem-solving occur here. Urgent blockers are first raised in Discord.
  \item \textbf{Email}: Formal communications, for external correspondence with the supervisor or course staff.
  \item \textbf{MS Teams}: Used for scheduled team meetings. Happen as needed for in-depth discussions, coordination of long term planning, and document/design/code reviews.
  \item \textbf{In-Person (Tutorial / Scheduled Check-ins)}: Used for structured milestone work, live demonstrations, and project progress feedback.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Meeting Chair/Note-taker (Ammar Sharbat)}: Facilitates meetings, ensures agenda is followed, and documents key discussion points and action items.
\end{itemize}
...
\begin{itemize}
	\item Implementation Complexity: Correctly enforcing the gameplay mechanism (e.g. game sessions, turn-taking, rule validation, base-12)
	\item Ensuring required libraries and frameworks install and integrate smoothly across team members’ environments.
	
\end{itemize}
\subsection*{PoC Demonstration Goals} 
In our PoC demonstration, we will address these risks by showing:
\begin{itemize}
	\item A working prototype of Crazy 10s where players can take turns, match cards by suit/rank, and play an "10" as a wild card to change suit.
	\item Successful integration between server and client for real-time gameplay.
\end{itemize}
...
Discord \& MS Teams & Used for real-time team communication, coordination, discussions and team meetings. & Collaboration \\ \hline
LaTeX & Used for professional documentation, including Development Plan, SRS, and VnV Plan deliverables. & Documentation \\ \hline
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    and how did you resolve them?\\One disagreement our group had was whether to focus solely on developing the Crazy Tens card game, or to make it into a product line that could support multiple card games/number systems,  some members felt that the product line idea would make the project impressive and ambitious, while others were concerned about the limited timeline and feasibility. After a team discussion and seeking advice from the professor and supervisor, we resolved this by agreeing to prioritize Crazy Tens as the core deliverable, ensuring we can deliver a complete and functional game. At the same time, we left the product line concept as a stretch goal that could be pursued if time and resources permit. This compromise allowed us to balance ambition with practicality, while keeping the team aligned.
\end{enumerate}
...
Team members are expected to attend scheduled meetings(in-person or via MS Teams) on time and stay until the meeting is concluded.  Consistent attendance is essential to maintain good communication and progress.
...
\begin{itemize}
  ...
  \item \textbf{Communication Responsiveness:} Weekday Discord messages acknowledged within 48 hours (a reaction or short reply). If unavailable (midterms, travel), communicate ahead of time if possible.
  \item \textbf{Constructive Feedback:} Use specific, friendly, actionable language and pair it with reasoning.
  \item \textbf{Conflict of Ideas:} Healthy debate is encouraged, and once a decision is recorded, team members support it unless new issues or evidence emerge.
...
\begin{itemize}
  \item Meeting attendance (lectures, tutorial check-ins, scheduled team meetings, supervisor check-ins)
  \item Number of issues added and number of issues closed
  \item Number of commits made
  \item Number of pull requests made and contributions to reviewing PRs
  \item Potential metric: Number of lines of code written (with context)
  \item Potential metric: Code quality (e.g., number of linter warnings/errors, test coverage)
\end{itemize}
