...
\title{Reflection and Traceability Report for\\\progname}
...
Some suggestions -Ammar\\
\textbf{SFWRENG 3RA3 - Software Requirements Engineering} for requirements elicitation, requirements analysis, requirements specification, and requirements validation.\\
\textbf{SFWRENG 3S03 - Software Testing} for test planning, test case design, unit testing and automated testing.\\
\textbf{SFWRENG 4C03 - Computer Networks and Security} for socket programming using Node.js and basic principles of web hosting using html.\\
\textbf{SFWRENG 4HC3 - Human Computer Interfaces} for the Human Centered Design process, stakeholder analysis, paper prototyping, real prototyping, usability testing, etc.\\
