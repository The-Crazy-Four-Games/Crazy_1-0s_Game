...
\begin{document}
    ...
    \begin{table}[hp]
        ...
        \begin{tabularx}{\textwidth}{llX}
            ...
            11.03 & Ammar Sharbat & Updates Titles\\
            04.06 & Ammar Sharbat & Problem Statement Updates (Problem, Inputs/Outputs, Stakeholders, Environment)\\
            04.06 & Ammar Sharbat & Goals Updates (MVP and Stretch Goals)\\
            04.06 & Ammar Sharbat & Added Extras\\
            \bottomrule
        \end{tabularx}
    \end{table}
    ...
    \section{Extras}
    For our web-based Crazy Eights game, we will be doing 2 extras: Usability Testing and Design Thinking.\\
    These Extras were approved by the Instructor Dr. Spencer Smith as part of our project discussion.
    \\\\
    \textbf{Usability Testing:} Perform a usability study with 5 participants to evaluate how well first-time users can play the game and understand Dozenal concepts.
    \begin{itemize}
        \item Define several tasks covering thing like gameplay, account setup, and understanding Dozenal.
        \item Use a System Usability Scale (SUS) questionnaire and custom questions for subjective feedback.
        \item Collect metrics like task completion rates, time on task, and error counts.
        \item Analyze results to identify learnability issues and educational value.
    \end{itemize}\\
    \\
    \textbf{Design Thinking:} Apply a user-centered design process to ensure the game is approachable and engaging for newcomers.
    \begin{itemize}
        \item Conduct interviews to understand user needs and barriers to learning Dozenal.
        \item Develop empathy maps and refine the problem definition based on insights of key users / stakeholders.
        \item Using ideation and iteration, create prototypes (like sketches, wireframes, interfaces) to explore design directions.
        \item Balance achieving educational goals and gameplay enjoyment.
    \end{itemize} 
